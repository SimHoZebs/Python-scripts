...
"""
make a set of coords in string
find union of two sets
find which union has the lowest distance
answer
"""

"""
PROBLEM: every move is same distance LMAO
make a list of the distance from origin
make a dictionary of coords: distance
PROBLEM: lists are unhashable
SOLUTION: turn list in to text
PROBLEM: distance can't be calculated because it's text
SOLUTION: make only dictionary item name a text
(Note: There will be diff coords with same distance)
sort list in ascending order
compare two lists of same distance
if same distance, make a list of coords with that distance
